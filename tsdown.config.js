...
// This keeps configuration loading compatible with the supported Node baseline.
...
export default defineConfig({
  ...
  // runtime file read to know its own version, which would be unsafe across
  // src/ and dist/ path depths.
  define: {

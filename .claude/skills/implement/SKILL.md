...
12. **Code review** — Codex review of the implementation (correctness, best practices, consistency with comments/plan) including the comment reconciliation: no stale spec tense, no line-by-line restatement of code, no dead references, public API JSDoc reads as consumer documentation. → `step12_code_review=done`
